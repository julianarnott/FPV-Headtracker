...
float angle;
int angleOut;
// use A6 for the wiper
//////////////////////////////////////////////////////////////////////////////////////////
void setup()
{ 
  // Set the initial start position for the wiper pin  
  // Depends on the setting for the controller
  // 0 - down
  // 124 - mid-way
  // 255 - up
  pinMode(wiperPin, OUTPUT);
  analogWrite(wiperPin, 124);
  int error;
  uint8_t c;
...
{
  angleCalc();
  // Work out what the max and min values I want to use and set these as the limits to protect the gimbal. Say 45 degrees up and 90 degrees down.
  angle = constrain(angle_y,-90,45);
  
  // Map these to the analogue output we're going to use for the signal to the phantom controller
  angleOut = map(angle,-90,45,0,255); 
  Serial.print("angle:"); Serial.print("\t"); Serial.print(angle_y); Serial.print("\t"); Serial.print("angleOut:"); Serial.print("\t"); Serial.println(angleOut);
  // NOTE: The range on the wiper of the pot on the Phantom controller is 0-3.3v
  
  analogWrite(wiperPin,angleOut);
  //check the voltage on this pin
}
//////////////////////////////////////////////////////////////////////////////////////////
void angleCalc()
{
